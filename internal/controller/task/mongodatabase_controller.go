...
func (r *MongoDatabaseReconciler) doReconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if r.ImportHandler.IsObjectBeingImported(importer.TYPE_MONGO_DATABASE, req.NamespacedName) {
	...
	if !db.ObjectMeta.DeletionTimestamp.IsZero() {
		...
		db.ObjectMeta.Finalizers = helpers.RemoveFromSlice(db.ObjectMeta.Finalizers, helpers.MongoFinalizerName)
	...
	if !helpers.SliceContains(db.ObjectMeta.Finalizers, helpers.MongoFinalizerName) {
