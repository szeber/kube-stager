...
type MysqlConfigDeleteHandler struct {
	Client client.Client
}

func (r *MysqlConfigDeleteHandler) Handle(ctx context.Context, req admission.Request) admission.Response {
	logger := log.FromContext(ctx)
	logger.Info("Validating deletion of mysql config " + req.Namespace + "/" + req.Name)
